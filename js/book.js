    ...
    bookLayout.pages.forEach((page, idx) => {
        ...
        switch (page.type) {
            ...
            case 'title':
                ...
                // Add flex centering style directly to title page
            ...
            case 'copyright':
                ...
                pageEl.style.display = 'flex';
                pageEl.style.flexDirection = 'column';
                pageEl.style.justifyContent = 'flex-end'; // Bottom align
                pageEl.style.padding = '40px';
                pageEl.innerHTML = `
                    <div class="copyright-content" style="text-align: center; font-size: 0.8rem; color: #888; font-family: sans-serif;">
                        <p>Generated by StoryPath</p>
